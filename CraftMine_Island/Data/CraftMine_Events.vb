...
Namespace CraftMine_V2
    ...
    Friend Module CraftMine_Events
        ...
        Public Sub CraftMine_Movement() ' Controls The Movement of The player 
            ...
            ElseIf My.Forms.Forest.Visible = True Then

                PlayerF.Movement()

            ElseIf My.Forms.Mountains.Visible = True Then

                PlayerM.Movement()

            ElseIf My.Forms.Beach.Visible = True Then
        ...
        Public Sub CraftMine_Data()  ' Controls all data in CraftMine
            ...
            For Each form In formlist
                If form.Visible = True Then
                    ...
                    My.Forms.Beach.Controls.Add(Shipp)

                    My.Forms.Forest.Controls.Add(message)
                End If
            Next
