...
Namespace CraftMine_V2
    ...
    Friend Module CraftMine_Subroutines
        ...
        Public Sub Ui_Label() ' This is used for the main UI of the player, which shows health, defence and points
            ...
            ui.Visible = True
            ui.Font = New Font("Microsoft Sans Serif", 22F, FontStyle.Bold)
        ...
        Public Sub Mining_Label()
            ...
            Mining.Font = New Font("Microsoft Sans Serif", 15F, FontStyle.Bold)
        ...
        Public Sub Ship_Label()
            ...
            Shipp.Visible = False
            Shipp.Font = New Font("Microsoft Sans Serif", 15F, FontStyle.Bold)
        ...
        Public Sub Sign_Label()
            ...
            message.Font = New Font("Microsoft Sans Serif", 15F, FontStyle.Bold)
            message.Size = New Size(470, 40)
        End Sub

        Public Sub CraftMine_Tutorial()

            My.Forms.Beach.Controls.Add(Tutorial)

            Tutorial.Visible = True
            Tutorial.Location = New Point(147, 211)
            Tutorial.Font = New Font("Microsoft Sans Serif", 22F, FontStyle.Bold)
